...
package video_hpp is
  ...
  -- actually wx - 7  
   ...
   package Class_Video is
      ...
      function get_sprites (this : access Video; sprites : access array_hpp.Class_c_array.c_array) return word_operations_hpp.size_t;  -- ./video.hpp:36
      ...
      --  skipped func _is_OAM

      --  skipped func _is_VRAM
   end;
   use Class_Video;
end video_hpp;
